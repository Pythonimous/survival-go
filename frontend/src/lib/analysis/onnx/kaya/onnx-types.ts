...
// Ported from kaya-go/kaya (AGPL-3.0), packages/ai-engine/src/onnx-types.ts
// Upstream commit: 8fafeac0fedde020c447d931c0b1afdf283edf2a

import type { GoBoard, Sign } from './goboard';
...
export interface OnnxEngineConfig extends BaseEngineConfig {
  ...
  /**
   * ORT wasm asset locations (string prefix or explicit mjs/wasm URLs).
   * Survival-Go uses blob URLs from `preloadThreadedOrtWasmPaths` for threaded dev.
   */
